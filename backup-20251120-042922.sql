...
\restrict kvxVqeCvjxSud7xNXcK30PdmR5FhHhhxb2kT9BrL0Q2gaenTfAQNX6rasJSmti2
...
--
-- Name: idx_appointments_user_scheduled; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_appointments_user_scheduled ON public.appointments USING btree (user_id, scheduled_at);


--
-- Name: idx_approved_lenders_request_status; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_approved_lenders_request_status ON public.approved_lenders USING btree (rate_request_id, approval_status);
...
--
-- Name: idx_customers_dealership_created; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_customers_dealership_created ON public.customers USING btree (dealership_id, created_at DESC);
...
--
-- Name: idx_customers_dealership_status; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_customers_dealership_status ON public.customers USING btree (dealership_id, status);
...
--
-- Name: idx_deals_dealership_state; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_deals_dealership_state ON public.deals USING btree (dealership_id, deal_state);
...
--
-- Name: idx_deals_salesperson; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_deals_salesperson ON public.deals USING btree (salesperson_id);
...
--
-- Name: idx_email_messages_dealership_read; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_email_messages_dealership_read ON public.email_messages USING btree (dealership_id, is_read);
...
--
-- Name: idx_rate_requests_deal_status; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_rate_requests_deal_status ON public.rate_requests USING btree (deal_id, status);
...
--
-- Name: idx_vehicles_dealership_condition; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_vehicles_dealership_condition ON public.vehicles USING btree (dealership_id, condition);
...
--
-- Name: idx_vehicles_dealership_status; Type: INDEX; Schema: public; Owner: neondb_owner
--

CREATE INDEX idx_vehicles_dealership_status ON public.vehicles USING btree (dealership_id, status);
...
\unrestrict kvxVqeCvjxSud7xNXcK30PdmR5FhHhhxb2kT9BrL0Q2gaenTfAQNX6rasJSmti2
