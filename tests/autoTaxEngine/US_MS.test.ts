...
describe('Mississippi (MS) Tax Rules Configuration', () => {
  ...
  describe('Retail - Vehicle Tax Scheme', () => {
    // Mississippi uses STATE_ONLY - no local taxes on vehicles
    // Per Mississippi Code § 27-65-201: uniform 5% statewide (or 3% for heavy trucks)
    // No county taxes, no city/municipal taxes on vehicles
