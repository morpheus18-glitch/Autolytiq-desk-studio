      ...
      <div className="md:col-span-2 p-4 rounded-lg bg-muted/50 border">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div>
            ...
            <div className="font-mono font-semibold tabular-nums" data-testid="text-selling-price">
              ${calculations.sellingPrice.toFixed(2)}
            </div>
          </div>
          <div>
            <div className="text-xs text-muted-foreground mb-1">Down Payment</div>
            <div className="font-mono font-semibold tabular-nums" data-testid="text-down-payment">
          ...
          <div>
            ...
            <div className="font-mono font-semibold tabular-nums text-primary" data-testid="text-amount-financed">
