...
export function MobileBottomNav() {
  ...
  return (
    <>
      ...
      <nav
        className="fixed bottom-0 left-0 right-0 z-50 bg-background border-t-2 border-neutral-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] md:hidden pb-safe"
        data-testid="mobile-bottom-nav"
      >
        <div className="grid grid-cols-6 gap-2 px-3 py-2 min-h-[64px] pb-safe">
